...
\label{tab:main}
\resizebox{\textwidth}{!}{\input{Experiment/results/main_results.tex}}
\end{table*}
...
\label{tab:ablation}
\resizebox{\columnwidth}{!}{\input{Experiment/results/ablation_results.tex}}
\end{table}
...
\label{tab:stats}
\resizebox{\columnwidth}{!}{\input{Experiment/results/stat_tests.tex}}
\end{table}
